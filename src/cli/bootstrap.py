...
# _run() moved to src/cli/launchers.py alongside the training launchers.
from src.cli.launchers import _run  # noqa: E402,F401


# ============================================================
# Direct-launch preflight (for `python start.py <task> <seed>`)
# Moved to src/cli/preflight.py. Re-imported here so main() below can
# keep calling the names unchanged.
# ============================================================
...
# Checkpoint discovery + run-dir introspection (including the
# RESUME_CONFIG_BY_PREFIX map) moved to src/cli/checkpoints.py.
